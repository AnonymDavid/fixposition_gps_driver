...
bool FixpositionDriverNode::StartNode() {
    ...
    if (params_.MessageEnabled(fpa::FpaOdometryPayload::MSG_NAME)) {
        ...
        _PUB(odometry_utm_pub_, geometry_msgs::msg::PoseWithCovarianceStamped, output_ns + "/odometry_utm", qos_settings_);
        ...
        driver_.AddFpaObserver(fpa::FpaOdometryPayload::MSG_NAME, [this](const fpa::FpaPayload& payload) {
            ...
            PublishFpaOdometryDataNavSatFixAndUtm(odometry_payload, params_.nav2_mode_, odometry_llh_pub_, odometry_utm_pub_);
